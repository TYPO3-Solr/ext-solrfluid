 ...
 */
class DateRange extends AbstractFacetItem
{
    /**
     * @var DateTime
     */
     ...
     * @param array $dateRangeCounts
     * @param bool $selected
     */
    public function __construct(DateRangeFacet $facet, DateTime $startRequested = null, DateTime $endRequested = null, DateTime $startInResponse = null, DateTime $endInResponse = null, $gap = '', $documentCount = 0, $dateRangeCounts, $selected = false)
    {
        ...
        $this->dateRangeCounts = $dateRangeCounts;
     ...
     * @return array
     */
    public function getDateRangeCounts()
    {
        return $this->dateRangeCounts;
    }
