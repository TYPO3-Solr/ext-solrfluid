...
/**
 * @package ApacheSolrForTypo3\Solrfluid\Domain\Search\ResultSet\Sorting
 */
class Sorting
{
     ...
     */
    public function __construct(SearchResultSet $resultSet, $name, $field, $direction, $label, $selected)
    {
