 ...
 */
class RemoveOptionViewHelper extends AbstractOptionViewHelper
{
    ...
    public function render()
    {
        ...
        $uri = $this->searchUriBuilder->getRemoveFacetOptionUri($previousRequest, $facet->getName(), $optionValue);
