...
use ApacheSolrForTypo3\Solrfluid\ViewHelpers\Uri\Facet\RemoveFacetViewHelper;
...
class RemoveFacetViewHelperTest extends AbstractFacetItemViewHelperTest
{
    ...
    public function removeFacetWillUseUriBuilderAsExpected()
    {
        ...
        $searchUriBuilderMock->expects($this->once())->method('getRemoveFacetUri')->with($facet->getResultSet()->getUsedSearchRequest(), 'Color', 'red');
